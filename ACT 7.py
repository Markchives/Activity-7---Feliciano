...
class PostgresCursor:
    ...
    def executemany(self, query, parameters):
        try:
            self._cursor.executemany(query.replace("?", "%s"), parameters)
        except Exception as exc:
            raise sqlite3.OperationalError(str(exc)) from exc
        return self
...
def init_postgres_db():
    ...
    try:
        statements = (
            "CREATE TABLE IF NOT EXISTS users (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, username TEXT UNIQUE NOT NULL, email TEXT UNIQUE NOT NULL, password_hash TEXT NOT NULL, failed_attempts INTEGER NOT NULL DEFAULT 0, lockout_until DOUBLE PRECISION NOT NULL DEFAULT 0, role TEXT NOT NULL DEFAULT 'USER', student_name TEXT NOT NULL DEFAULT '', student_number TEXT NOT NULL DEFAULT '', section TEXT NOT NULL DEFAULT '')",
            "CREATE TABLE IF NOT EXISTS hardware (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name TEXT UNIQUE NOT NULL, category TEXT NOT NULL, quantity INTEGER NOT NULL, unit_price DOUBLE PRECISION NOT NULL, status TEXT NOT NULL)",
            "CREATE TABLE IF NOT EXISTS password_reset_requests (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, username TEXT NOT NULL, email TEXT NOT NULL, requested_at DOUBLE PRECISION NOT NULL, status TEXT NOT NULL DEFAULT 'PENDING', admin_comment TEXT DEFAULT '', approved_by TEXT DEFAULT '')",
            "CREATE TABLE IF NOT EXISTS activity_records (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, event_type TEXT NOT NULL, item_id BIGINT, item_name TEXT NOT NULL, username TEXT NOT NULL, quantity INTEGER NOT NULL DEFAULT 0, quantity_delta INTEGER NOT NULL DEFAULT 0, occurred_at DOUBLE PRECISION NOT NULL, details TEXT NOT NULL DEFAULT '')",
            "CREATE TABLE IF NOT EXISTS borrow_requests (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, username TEXT NOT NULL, item_id BIGINT NOT NULL, quantity INTEGER NOT NULL, purpose TEXT NOT NULL, requested_at DOUBLE PRECISION NOT NULL, status TEXT NOT NULL DEFAULT 'PENDING', decided_by TEXT DEFAULT '', decided_at DOUBLE PRECISION DEFAULT 0)",
            "CREATE TABLE IF NOT EXISTS laboratory_reports (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, username TEXT NOT NULL, report_type TEXT NOT NULL, item_id BIGINT, details TEXT NOT NULL, reported_at DOUBLE PRECISION NOT NULL, status TEXT NOT NULL DEFAULT 'OPEN', reviewed_by TEXT DEFAULT '')",
            "CREATE TABLE IF NOT EXISTS laboratory_schedules (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, section TEXT NOT NULL, subject TEXT NOT NULL, instructor TEXT NOT NULL, room TEXT NOT NULL, schedule_date TEXT NOT NULL, start_time TEXT NOT NULL, end_time TEXT NOT NULL, created_by TEXT NOT NULL, created_at DOUBLE PRECISION NOT NULL)",
        )
...
class TrackerController:
    ...
    def add_item(self, item_name, category, quantity, unit_price, changed_by="ADMIN"):
        ...
        try:
            ...
            cursor = conn.cursor()
            cursor.execute(
                "INSERT INTO hardware (name, category, quantity, unit_price, status) VALUES (?, ?, ?, ?, ?) RETURNING id",
            ...
            cursor.execute(
                ...
                VALUES ('STOCK_ADD', ?, ?, ?, ?, ?, ?, ?)
                """,
                (item_id, validated.item_name, changed_by, validated.quantity, validated.quantity, time.time(), "Item added to inventory"),
            )
            conn.commit()
            conn.close()
